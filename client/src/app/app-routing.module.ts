...
{ path: 'spreadsheet/:id', loadChildren: () => import('./page/spreadsheet/spreadsheet.module').then(m => m.SpreadsheetModule) },
...
{ path: 'test', loadChildren: () => import('./page/test/test.module').then(m => m.TestModule) }];
